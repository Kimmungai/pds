...
<section class="enquire">
  ...
  <div class="container section-decoration">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        @if($client->avatar == '')
        <div class="public-profile-pic"><img src="{{asset('/avatar/avatar.jpg')}}" alt="{{$client->first_name}} image"></div>
        @else
        <div class="public-profile-pic"><img src="/{{$client->avatar}}" alt="{{$client->first_name}} image"></div>
        @endif
      </div>
      <div class="col-md-4">
           ...
           <div class="col-md-6">
             <h4 class="text-muted">Bidding information</h4>
              <ul class="list-group">
                 ...
                 @if($project['final_price']!='')
                 <li class="list-group-item">Final price: <span class="bold red">$ {{round($project['final_price'],2)}}</span></li>
                 @elseif($project['avg_price']=='')
                 <li class="list-group-item">Average price: <span class="bold red">-</span></li>
                 @else
                 <li class="list-group-item">Average price: <span class="bold red">$ {{round($project['avg_price'],2)}}</span></li>
                 @endif
                 @if($project['final_price']=='')
               ...
               <div class="col-md-6">
                 <h4 class="text-muted">Client information</h4>
                   <ul class="list-group">
                       ...
                       @else
                       <li class="list-group-item">Desired price: <span class="bold">$ {{round($project['desired_price'],2)}}</span></li>
                       @endif
