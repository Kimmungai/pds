             ...
             <form action="/new-project-schedule" method="POST">
              {{ csrf_field() }}
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input name="desired_price" type="number" class="form-control" value="{{$data['desired_price']}}" placeholder="Amount in $" />
            ...
            <form action="/new-project-schedule" method="POST">
             {{ csrf_field() }}
               ...
               <div class="row">
                 ...
                 <div class="col-md-10">
                   <input name="desired_price" type="number" class="form-control" value="{{ old('desired_price') }}" placeholder="Amount in $" />
                   @if ($errors->has('desired_price'))
                     <span class="red">
                         <strong>{{ $errors->first('desired_price') }}</strong>
                     </span>
